      ...
      steps: [
        {
          ...
          schema: tableSchema({
            ...
            { name: "name", type: "string" },
            { name: "description", type: "string", isOptional: true },
            { name: "schedule_type", type: "string" }, // age_based | date_based | group_based
            { name: "target_age_months", type: "number", isOptional: true },
            { name: "age_window_days", type: "number", isOptional: true },
            { name: "scheduled_date", type: "number", isOptional: true },
            { name: "repeat_annually", type: "boolean" },
            { name: "pasture_id", type: "string", isOptional: true, isIndexed: true },
            { name: "interval_months", type: "number", isOptional: true },
            { name: "last_applied_date", type: "number", isOptional: true },
            { name: "target_species", type: "string", isOptional: true },
            { name: "target_sex", type: "string", isOptional: true },
            { name: "min_age_months", type: "number", isOptional: true },
            { name: "max_age_months", type: "number", isOptional: true },
            { name: "requires_booster", type: "boolean" },
            { name: "booster_interval_days", type: "number", isOptional: true },
            { name: "booster_count", type: "number" },
            { name: "is_active", type: "boolean" },
            { name: "created_at", type: "number" },
            { name: "updated_at", type: "number" },
            { name: "is_deleted", type: "boolean" },
        ...
        },
        {
          ...
          schema: tableSchema({
            ...
            { name: "health_record_id", type: "string", isOptional: true, isIndexed: true },
            { name: "status", type: "string" }, // pending | administered | overdue | skipped
            { name: "due_date", type: "number" },
            { name: "administered_date", type: "number", isOptional: true },
            { name: "dose_number", type: "number" },
            { name: "booster_due_date", type: "number", isOptional: true },
            { name: "parent_vaccination_id", type: "string", isOptional: true, isIndexed: true },
