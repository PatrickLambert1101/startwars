const en = {
  ...
  dashboardScreen: {
    ...
    leaveFarmConfirm: {
      title: "Leave farm?",
      message: "Are you sure you want to leave {{farm}}? You'll lose access to its animals and records until you're invited again.",
    },
    leaveFarmLastAdmin: "You're the last admin of this farm. Make someone else an admin, or delete the farm, before leaving.",
    pendingInvite: {
      title: "You've been invited",
      subtitle: "Join {{farm}} as a {{role}}.",
  ...
  reportsScreen: {
    ...
    sections: {
      ...
      movements: "Camp movements",
    },
    breedingOutcomes: {
      live_calf: "Live calf",
      pending: "Pregnant / waiting",
      stillborn: "Stillborn",
      aborted: "Aborted",
      open: "Open",
    },
    dashboard: {
      emptyTitle: "No herd data yet",
      other: "Other",
      glance: {
        title: "Herd at a Glance",
        subtitle: "Your whole herd in one look",
        dueToCalve: "Due to calve",
      },
      makeup: {
        title: "Herd Makeup",
        subtitle: "Tap a bar to see those animals",
        breed: "Breed",
        sex: "Sex",
        age: "Age",
      },
      growth: {
        title: "Growth",
        subtitle: "See how your herd is growing",
        avgWeight: "Avg weight",
        adg: "Daily gain",
        empty: "Weigh your animals a few times to see the trend here.",
      },
      breeding: {
        title: "Calves & Breeding",
        subtitle: "How your breeding season is going",
        calvingRate: "Calving success",
        pending: "Waiting",
        empty: "No breeding records yet.",
      },
      vaccinations: {
        title: "Vaccinations",
        subtitle: "Tap to see what's due",
        coverage: "Up to date",
        overdue: "Overdue",
      },
      pastures: {
        title: "Camps",
        subtitle: "How full each camp is",
      },
    },
    myReports: {
      newReport: "+ New Report",
      emptyTitle: "Build your first report",
      emptyDescription:
        "Pick your own filters and groups — like \"Weaner weights by camp\" — and save it to run any time.",
      deleteTitle: "Delete report?",
      deleteMessage: "\"{{name}}\" will be removed. Your animals are not affected.",
    ...
    builder: {
      ...
      namePlaceholder: "e.g. Weaner weights by camp",
      descriptionLabel: "Description (optional)",
      descriptionPlaceholder: "What is this report for?",
      nameRequiredTitle: "Name needed",
      nameRequiredMessage: "Give your report a name so you can find it again.",
      runButton: "Run Report",
      saveButton: "Save Report",
      updateButton: "Save Changes",
      filters: {
        title: "Which animals?",
        subtitle: "Leave everything off to include the whole herd.",
        species: "Species",
        status: "Status",
        sex: "Sex",
        breed: "Breed",
        ...
        ageTo: "To",
        tags: "Labels",
        tagsPlaceholder: "e.g. Breeding Stock",
        pasture: "Camp",
      },
      groupBy: {
        title: "Group them by",
        subtitle: "Splits the report into sections with counts.",
        none: "No grouping",
      },
      columns: {
        title: "What to show",
        subtitle: "Columns for each animal in the report.",
      },
      sections: {
        title: "Extra history",
        subtitle: "Adds full history pages to PDF and Excel exports.",
      },
    },
    viewer: {
      defaultTitle: "Herd Report",
      running: "Putting your report together...",
      emptyTitle: "No animals match",
      emptyDescription: "Try removing some filters and run it again.",
      totalAnimals_one: "{{count}} animal",
      totalAnimals_other: "{{count}} animals",
      groupedBy: "Grouped by {{field}}",
    ...
    export: {
      working: "Working...",
      traceability: {
        title: "Traceability Certificate (PDF)",
        description:
          "A professional PDF with each animal's full history — identity, parents, health, weights, breeding and movements. Ready for buyers, auctions and audits.",
        button: "Create PDF Certificate",
      },
      excel: {
        title: "Full Herd Spreadsheet (Excel)",
        description:
          "One Excel file with your whole herd — animals, health, weights, breeding and movements on separate sheets.",
        button: "Create Excel File",
      },
      csv: {
        title: "Simple List (CSV)",
        description: "A plain list of your animals that opens in any spreadsheet app.",
        button: "Create CSV File",
      },
      workbook: {
        farm: "Farm",
        generated: "Generated",
        ...
        healthSheet: "Health",
        weightsSheet: "Weights",
        breedingSheet: "Breeding",
      ...
      pdf: {
        traceabilityTitle: "Livestock Traceability Certificate",
        generatedAt: "Generated",
        generatedBy: "By",
        footer: "Generated with HerdTrackr — herd records you can trust.",
        identification: "Animal Identification",
        parentage: "Parentage",
        sire: "Sire",
        dam: "Dam",
        photos: "Photos",
        morePhotos_one: "{{count}} more photo on file",
        morePhotos_other: "{{count}} more photos on file",
        healthRecords: "Health Records",
        weightRecords: "Weight Records",
        breedingRecords: "Breeding Records",
        movementHistory: "Camp Movement History",
        ...
        actualCalving: "Actual calving",
        movedBy: "Moved by",
        animalOf: "Animal {{current}} of {{total}}",
        totalAnimals_one: "{{count}} animal in this report",
        totalAnimals_other: "{{count}} animals in this report",
        visualTag: "Visual tag",
        rfidTag: "RFID tag",
        name: "Name",
        herdTag: "Herd/group tag",
  ...
  teamScreen: {
    ...
    noFarm: {
      title: "No farm yet",
      subtitle: "Your team is the members of a farm. Create a farm to start building your team, or accept an invite to join one.",
      button: "Create a Farm",
    },
    loading: "Loading...",
    inviteButton: "+ Invite",
    inviteForm: {
