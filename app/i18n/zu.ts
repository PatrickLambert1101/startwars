const zu = {
  networkBanner: {
    offline: "Awuxhunywe ku-inthanethi",
    backOnline: "Usuxhunywe futhi",
  },
  common: {
    ok: "Kulungile",
    cancel: "Khansela",
  ...
  dashboardScreen: {
    ...
    loadingFarms: "Ilayisha amapulazi akho…",
    switchFarm: "Shintsha Ipulazi",
    createNewFarm: "+ Dala Ipulazi Elisha",
    leaveFarm: "Shiya Ipulazi",
    leaveFarmConfirm: {
      title: "Shiya ipulazi?",
      message: "Uqinisekile ufuna ukushiya i-{{farm}}? Uzolahlekelwa ukufinyelela ezilwaneni zayo namarekhodi uze umenywe futhi.",
    },
    leaveFarmLastAdmin: "Ungumlawuli wokugcina waleli pulazi. Yenza omunye umuntu abe ngumlawuli, noma usule ipulazi, ngaphambi kokuhamba.",
    pendingInvite: {
      title: "Umenyiwe",
      subtitle: "Joyina i-{{farm}} njenge-{{role}}.",
      accept: "Yamukela Isimemo",
      errorTitle: "Ayikwazanga ukwamukela isimemo",
      role: {
        admin: "umphathi",
        worker: "isisebenzi",
      },
  ...
  reportsScreen: {
    ...
    ageBrackets: {
      under_6m: "Ngaphansi kwezinyanga ezi-6",
      "6_12m": "Izinyanga ezi-6–12",
      "1_2y": "Unyaka 1–2",
      "2_5y": "Iminyaka 2–5",
    ...
    columns: {
      ...
      breed: "Uhlobo",
      sex: "Ubulili",
      age: "Ubudala (izinyanga)",
      status: "Isimo",
      herdTag: "Ithegi yomhlambi",
      latestWeight: "Isisindo sakamuva (kg)",
      tags: "Amalebula",
    },
    groupBy: {
      breed: "Uhlobo",
    ...
    sections: {
      health: "Amarekhodi empilo",
      weights: "Amarekhodi ezisindo",
      breeding: "Amarekhodi okuzalanisa",
      movements: "Ukunyakaza kwamakamu",
    },
    breedingOutcomes: {
      live_calf: "Ithole eliphilayo",
      pending: "Ikhulelwe / ilindile",
      stillborn: "Elizelwe lifile",
      aborted: "Kuphunyiwe",
      open: "Ayikhulelwanga",
    },
    dashboard: {
      emptyTitle: "Ayikho idatha yomhlambi okwamanje",
      other: "Okunye",
      glance: {
        title: "Umhlambi Ngokushesha",
        subtitle: "Wonke umhlambi wakho ngokubuka kanye",
        dueToCalve: "Ezozala",
      },
      makeup: {
        title: "Ukwakheka Komhlambi",
        subtitle: "Thepha ibha ukubona lezo zilwane",
        breed: "Uhlobo",
        sex: "Ubulili",
        age: "Ubudala",
      },
      growth: {
        title: "Ukukhula",
        subtitle: "Bona ukuthi umhlambi wakho ukhula kanjani",
        avgWeight: "Isisindo esimaphakathi",
        adg: "Ukwanda kosuku",
        empty: "Kala izilwane zakho izikhathi ezimbalwa ukubona umkhondo lapha.",
      },
      breeding: {
        title: "Amathole & Ukuzalanisa",
        subtitle: "Ukuthi isizini yakho yokuzalanisa ihamba kanjani",
      ...
      vaccinations: {
        title: "Imigomo",
        subtitle: "Thepha ukubona okufanele kwenziwe",
        coverage: "Kuvuselelwe",
        overdue: "Sekudlulile isikhathi",
      },
      pastures: {
        title: "Amakamu",
        subtitle: "Ukuthi ikamu ngalinye ligcwele kangakanani",
      },
    },
    myReports: {
      newReport: "+ Umbiko Omusha",
      emptyTitle: "Yakha umbiko wakho wokuqala",
      emptyDescription:
        "Khetha ezakho izihlungi namaqembu — uwagcine ukuze uwaphinde noma nini.",
      deleteTitle: "Susa umbiko?",
      deleteMessage: "\"{{name}}\" uzosuswa. Izilwane zakho azithinteki.",
      lastRun: "Ugcine ukuqhutshwa {{date}}",
      neverRun: "Awukaqhutshwa",
    },
    builder: {
      title: "Umbiko Omusha",
      editTitle: "Hlela Umbiko",
      nameLabel: "Igama lombiko",
      namePlaceholder: "isb. Izisindo zamathole ngekamu",
      descriptionLabel: "Incazelo (ongakhetha)",
      descriptionPlaceholder: "Uwombiko wani lo?",
      nameRequiredTitle: "Kudingeka igama",
      nameRequiredMessage: "Nikeza umbiko wakho igama ukuze uwuthole futhi.",
      runButton: "Qhuba Umbiko",
      saveButton: "Londoloza Umbiko",
      updateButton: "Londoloza Izinguquko",
      filters: {
        title: "Yiziphi izilwane?",
        subtitle: "Shiya konke kuvaliwe ukufaka wonke umhlambi.",
        species: "Uhlobo lwesilwane",
        status: "Isimo",
        sex: "Ubulili",
        breed: "Uhlobo",
        age: "Ubudala (izinyanga)",
        ...
        ageTo: "Kuya",
        tags: "Amalebula",
        tagsPlaceholder: "isb. Imfuyo yokuzalanisa",
        pasture: "Ikamu",
      },
      groupBy: {
        title: "Zihlukanise nge",
        subtitle: "Kuhlukanisa umbiko ube izigaba ezinamanani.",
        none: "Akukho kuhlukanisa",
      },
      columns: {
        title: "Okuzoboniswa",
        subtitle: "Amakholomu esilwane ngasinye embikweni.",
      },
      sections: {
        title: "Umlando owengeziwe",
        subtitle: "Kwengeza amakhasi omlando ophelele kuma-PDF nama-Excel.",
      },
    },
    viewer: {
      defaultTitle: "Umbiko Womhlambi",
      running: "Sihlanganisa umbiko wakho...",
      emptyTitle: "Azikho izilwane ezifanayo",
      emptyDescription: "Zama ukususa ezinye izihlungi bese uyawuqhuba futhi.",
      totalAnimals_one: "Isilwane esi-{{count}}",
      totalAnimals_other: "Izilwane ezi-{{count}}",
      groupedBy: "Kuhlukaniswe nge {{field}}",
      allAnimals: "Zonke izilwane",
      ungrouped: "Akuhlukanisiwe",
    ...
    export: {
      working: "Iyasebenza...",
      traceability: {
        title: "Isitifiketi Sokulandelela (PDF)",
        description:
          "I-PDF yobungcweti enomlando ophelele wesilwane ngasinye — ubunikazi, abazali, impilo, izisindo, ukuzalanisa nokunyakaza. Ilungele abathengi, izindali nokuhlolwa.",
        button: "Yenza Isitifiketi se-PDF",
      },
      excel: {
        title: "Ispredishithi Somhlambi Ophelele (Excel)",
        description:
          "Ifayela elilodwa le-Excel elinomhlambi wakho wonke — izilwane, impilo, izisindo, ukuzalanisa nokunyakaza emakhasini ahlukene.",
        button: "Yenza Ifayela le-Excel",
      },
      csv: {
        title: "Uhlu Olulula (CSV)",
        description: "Uhlu olulula lwezilwane zakho oluvuleka kunoma iyiphi i-app yespredishithi.",
        button: "Yenza Ifayela le-CSV",
      },
      workbook: {
        farm: "Ipulazi",
        generated: "Kukhiqiziwe",
        totalAnimals: "Izilwane sezizonke",
        summarySheet: "Isifinyezo",
        animalsSheet: "Izilwane",
        healthSheet: "Impilo",
        weightsSheet: "Izisindo",
        breedingSheet: "Ukuzalanisa",
        movementsSheet: "Ukunyakaza",
        groupColumn: "Iqembu",
        date: "Usuku",
        type: "Uhlobo",
        ...
        product: "Umkhiqizo",
        dosage: "Ilinganiso",
        administeredBy: "Kunikezwe ngu",
        weightKg: "Isisindo (kg)",
        conditionScore: "Amaphuzu esimo",
        method: "Indlela",
        outcome: "Umphumela",
        expectedCalving: "Ukuzala okulindelekile",
        actualCalving: "Ukuzala kwangempela",
        pasture: "Ikamu",
      },
      pdf: {
        traceabilityTitle: "Isitifiketi Sokulandelela Imfuyo",
        generatedAt: "Kukhiqizwe",
        generatedBy: "Ngu",
        footer: "Kukhiqizwe nge-HerdTrackr — amarekhodi omhlambi ongawathemba.",
        identification: "Ubunikazi Besilwane",
        parentage: "Abazali",
        sire: "Uyise",
        dam: "Unina",
        photos: "Izithombe",
        morePhotos_one: "Esinye isithombe esi-{{count}} kwirekhodi",
        morePhotos_other: "Ezinye izithombe ezi-{{count}} kwirekhodi",
        healthRecords: "Amarekhodi Empilo",
        weightRecords: "Amarekhodi Ezisindo",
        breedingRecords: "Amarekhodi Okuzalanisa",
        movementHistory: "Umlando Wokunyakaza Kwamakamu",
        noRecords: "Awekho amarekhodi.",
        date: "Usuku",
        type: "Uhlobo",
        description: "Incazelo",
        product: "Umkhiqizo",
        ...
        administeredBy: "Kunikezwe ngu",
        weightKg: "Isisindo (kg)",
        conditionScore: "Isimo",
        method: "Indlela",
        outcome: "Umphumela",
        expectedCalving: "Ukuzala okulindelekile",
        actualCalving: "Ukuzala kwangempela",
        movedBy: "Kunyakaziswe ngu",
        animalOf: "Isilwane {{current}} kwezi-{{total}}",
        totalAnimals_one: "Isilwane esi-{{count}} kulo mbiko",
        totalAnimals_other: "Izilwane ezi-{{count}} kulo mbiko",
        visualTag: "Ithegi ebonakalayo",
        rfidTag: "Ithegi ye-RFID",
        name: "Igama",
        herdTag: "Ithegi yomhlambi/yeqembu",
        ...
        status: "Isimo",
        recordCreated: "Irekhodi lenziwe",
        notes: "Amanothi",
      },
    },
    traceability: {
  ...
  teamScreen: {
    title: "Iqembu",
    noFarm: {
      title: "Alikho ipulazi okwamanje",
      subtitle: "Iqembu lakho ngamalungu epulazi. Dala ipulazi ukuze uqale ukwakha iqembu lakho, noma wamukele isimemo ukuze ujoyine elinye.",
      button: "Dala Ipulazi",
    },
    loading: "Iyalayisha...",
    inviteButton: "+ Mema",
