const xh = {
  networkBanner: {
    offline: "Awuxhunyiwe kwi-intanethi",
    backOnline: "Uxhunywe kwakhona",
  },
  common: {
    ok: "KULUNGILE",
    cancel: "Rhoxisa",
  ...
  dashboardScreen: {
    ...
    loadingFarms: "Ilayisha iifama zakho…",
    switchFarm: "Tshintsha Ifama",
    createNewFarm: "+ Yenza Ifama Entsha",
    leaveFarm: "Shiya Ifama",
    leaveFarmConfirm: {
      title: "Shiya ifama?",
      message: "Uqinisekile ufuna ukushiya i-{{farm}}? Uya kuphulukana nokufikelela kwizilwanyana zayo neerekhodi de ubuye umenywe kwakhona.",
    },
    leaveFarmLastAdmin: "Ungumlawuli wokugqibela wale fama. Yenza omnye umntu abe ngumlawuli, okanye ucime ifama, phambi kokuba uhambe.",
    pendingInvite: {
      title: "Umenyiwe",
      subtitle: "Joyina i-{{farm}} njenge-{{role}}.",
      accept: "Yamkela Isimemo",
      errorTitle: "Akukwazekanga ukwamkela isimemo",
      role: {
        admin: "umphathi",
        worker: "umsebenzi",
      },
    ...
    recentAnimals: {
      ...
      empty:
        "Akukho zilwanyana okwangoku. Yiya kwithebhu yoMhlambi ukuze wongeze isilwanyana sakho sokuqala.",
    },
  },
  settingsScreen: {
    title: "Iisetingi",
    ...
    subscription: {
      ...
      descriptions: {
        ...
        starter:
          "Zonke iimpawu zibandakanyiwe simahla, kuze kube zizilwanyana ezingu-50. Phucula ukuze ufumane izilwanyana ezingenamda.",
      },
      buttons: {
    ...
    rfid: {
      ...
      powerSaved: "Amandla okufunda amiselwe ku-{{power}} dBm",
      rangeHint:
        "{{min}}–{{max}} dBm. Amandla aphezulu angafunda iithegi ezikude, kodwa angafunda nezilwanyana ezikufuphi. Umgama awunyuki ngokulinganayo.",
      presets: {
        low: "Ephantsi",
        med: "Phakathi",
        high: "Phezulu",
    ...
    dangerZone: {
      ...
      resetDescription:
        "Icima YONKE idatha yendawo. Sebenzisa kuphela xa uqala phantsi emva kokuba ucime iSupabase.",
      resetButton: "Cima Idatha Yendawo",
      alerts: {
        confirmTitle: "Setha Kwakhona Idatha Yendawo",
        confirmMessage:
          "Oku kuya kucima YONKE idatha yendawo kuquka umbutho wakho, izilwanyana, neerekhodi. Oku akunakubuyiselwa!\\n\\nYenza oku kuphela ukuba uqala phantsi emva kokuba ucime iSupabase.",
  ...
  reportsScreen: {
    ...
    ageBrackets: {
      under_6m: "Ngaphantsi kweenyanga ezi-6",
      "6_12m": "Iinyanga ezi-6–12",
      "1_2y": "Unyaka 1–2",
      "2_5y": "Iminyaka 2–5",
      over_5y: "Ngaphezu kweminyaka emi-5",
      unknown: "Ubudala abaziwa",
    },
    columns: {
      visualTag: "Ithegi",
      rfidTag: "RFID",
      ...
      breed: "Uhlobo",
      sex: "Isini",
      age: "Ubudala (iinyanga)",
      status: "Imeko",
      herdTag: "Ithegi yomhlambi",
      latestWeight: "Ubunzima bamva nje (kg)",
      tags: "Iileyibhile",
    },
    groupBy: {
      breed: "Uhlobo",
    ...
    sections: {
      health: "Iirekhodi zempilo",
      weights: "Iirekhodi zobunzima",
      breeding: "Iirekhodi zokuzala",
      movements: "Ukushukuma kweekampu",
    },
    breedingOutcomes: {
      live_calf: "Ithole eliphilayo",
      pending: "Imithi / ilindile",
      stillborn: "Elizelwe lifile",
      aborted: "Kuphunyiwe",
      open: "Ayimithanga",
    },
    dashboard: {
      emptyTitle: "Akukho data yomhlambi okwangoku",
      other: "Ezinye",
      glance: {
        title: "Umhlambi Ngokukhawuleza",
        subtitle: "Wonke umhlambi wakho ngokujonga kanye",
        dueToCalve: "Eza kuzala",
      },
      makeup: {
        title: "Ubume boMhlambi",
        subtitle: "Cofa ibha ukubona ezo zilwanyana",
        breed: "Uhlobo",
        sex: "Isini",
        age: "Ubudala",
      },
      growth: {
        title: "Ukukhula",
        subtitle: "Bona indlela umhlambi wakho okhula ngayo",
        avgWeight: "Ubunzima obuphakathi",
        adg: "Ukwanda kosuku",
        empty: "Linda izilwanyana zakho amaxesha ambalwa ukubona umkhondo apha.",
      },
      breeding: {
        title: "Amathole & Ukuzala",
        subtitle: "Indlela ixesha lakho lokuzalanisa elihamba ngayo",
        calvingRate: "Impumelelo yokuzala",
        pending: "Alindile",
        empty: "Akukho zirekhodi zokuzala okwangoku.",
      },
      vaccinations: {
        title: "Ugonyo",
        subtitle: "Cofa ukubona okufunekayo",
        coverage: "Sekugqityiwe",
        overdue: "Sekudlulile ixesha",
      },
      pastures: {
        title: "Iikampu",
        subtitle: "Indlela ikampu nganye ezele ngayo",
      },
    },
    myReports: {
      newReport: "+ Ingxelo Entsha",
      emptyTitle: "Yakha ingxelo yakho yokuqala",
      emptyDescription:
        "Khetha ezakho izihluzi namaqela — uzigcine ukuze uziphinde nanini na.",
      deleteTitle: "Cima ingxelo?",
      deleteMessage: "\"{{name}}\" iza kususwa. Izilwanyana zakho azichaphazeleki.",
      lastRun: "Igqityelwe {{date}}",
      neverRun: "Ayikaqhutywa",
    },
    builder: {
      title: "Ingxelo Entsha",
      editTitle: "Hlela Ingxelo",
      nameLabel: "Igama lengxelo",
      namePlaceholder: "umz. Ubunzima bamathole ngekampu",
      descriptionLabel: "Inkcazo (ayinyanzelekanga)",
      descriptionPlaceholder: "Yeyantoni le ngxelo?",
      nameRequiredTitle: "Kufuneka igama",
      nameRequiredMessage: "Nika ingxelo yakho igama ukuze uyifumane kwakhona.",
      runButton: "Qhuba Ingxelo",
      saveButton: "Gcina Ingxelo",
      updateButton: "Gcina Utshintsho",
      filters: {
        title: "Zeziphi izilwanyana?",
        subtitle: "Yeka konke kucinyiwe ukufaka wonke umhlambi.",
        species: "Uhlobo lwesilwanyana",
        status: "Imeko",
        sex: "Isini",
        breed: "Uhlobo",
        age: "Ubudala (iinyanga)",
        ...
        ageTo: "Ukuya",
        tags: "Iileyibhile",
        tagsPlaceholder: "umz. Imfuyo yokuzalisa",
        pasture: "Ikampu",
      },
      groupBy: {
        title: "Zahlule ngokwe",
        subtitle: "Yahlula ingxelo ibe ngamacandelo anamanani.",
        none: "Akukho kwahlula",
      },
      columns: {
        title: "Okuza kuboniswa",
        subtitle: "Iikholamu zesilwanyana ngasinye kwingxelo.",
      },
      sections: {
        title: "Imbali eyongezelelweyo",
        subtitle: "Yongeza amaphepha embali epheleleyo kwii-PDF nee-Excel.",
      },
    },
    viewer: {
      defaultTitle: "Ingxelo yoMhlambi",
      running: "Idibanisa ingxelo yakho...",
      emptyTitle: "Akukho zilwanyana zihambelanayo",
      emptyDescription: "Zama ukususa ezinye izihluzi uphinde uyiqhube.",
      totalAnimals_one: "Isilwanyana esi-{{count}}",
      totalAnimals_other: "Izilwanyana ezi-{{count}}",
      groupedBy: "Yahlulwe ngokwe {{field}}",
      allAnimals: "Zonke izilwanyana",
      ungrouped: "Azahlulwanga",
      months_one: "{{count}} iny",
      months_other: "{{count}} iny",
    },
    export: {
      working: "Iyasebenza...",
      traceability: {
        title: "Isatifikethi soKulandelela (PDF)",
        description:
          "I-PDF yobungcali enembali epheleleyo yesilwanyana ngasinye — isazisi, abazali, impilo, ubunzima, ukuzala nokushukuma. Ilungele abathengi, iifandesi novavanyo.",
        button: "Yenza Isatifikethi se-PDF",
      },
      excel: {
        title: "Ispredishiti soMhlambi oPheleleyo (Excel)",
        description:
          "Ifayile enye ye-Excel enomhlambi wakho wonke — izilwanyana, impilo, ubunzima, ukuzala nokushukuma kumaphepha ahlukeneyo.",
        button: "Yenza iFayile ye-Excel",
      },
      csv: {
        title: "Uluhlu oluLula (CSV)",
        description: "Uluhlu olulula lwezilwanyana zakho oluvulekayo kuyo nayiphi na i-app yespredishiti.",
        button: "Yenza iFayile ye-CSV",
      },
      workbook: {
        farm: "Ifama",
        generated: "Yenziwe",
        totalAnimals: "Izilwanyana zizonke",
        summarySheet: "Isishwankathelo",
        animalsSheet: "Izilwanyana",
        healthSheet: "Impilo",
        weightsSheet: "Ubunzima",
        breedingSheet: "Ukuzala",
        movementsSheet: "Ukushukuma",
        groupColumn: "Iqela",
        date: "Umhla",
        type: "Uhlobo",
        description: "Inkcazo",
        product: "Imveliso",
        dosage: "Umlinganiselo",
        administeredBy: "Inikwe ngu",
        weightKg: "Ubunzima (kg)",
        conditionScore: "Amanqaku emeko",
        method: "Indlela",
        outcome: "Isiphumo",
        expectedCalving: "Ukuzala okulindelekileyo",
        actualCalving: "Ukuzala kwenyani",
        pasture: "Ikampu",
      },
      pdf: {
        traceabilityTitle: "Isatifikethi soKulandelela iMfuyo",
        generatedAt: "Yenziwe",
        generatedBy: "Ngu",
        footer: "Yenziwe nge-HerdTrackr — iirekhodi zomhlambi onokuzithemba.",
        identification: "Isazisi seSilwanyana",
        parentage: "Abazali",
        sire: "Uyise",
        dam: "Unina",
        photos: "Iifoto",
        morePhotos_one: "Enye ifoto e-{{count}} kwirekhodi",
        morePhotos_other: "Ezinye iifoto ezi-{{count}} kwirekhodi",
        healthRecords: "Iirekhodi zeMpilo",
        weightRecords: "Iirekhodi zobuNzima",
        breedingRecords: "Iirekhodi zokuZala",
        movementHistory: "Imbali yokuShukuma kweeKampu",
        noRecords: "Akukho zirekhodi.",
        date: "Umhla",
        type: "Uhlobo",
        description: "Inkcazo",
        product: "Imveliso",
        ...
        administeredBy: "Inikwe ngu",
        weightKg: "Ubunzima (kg)",
        conditionScore: "Imeko",
        method: "Indlela",
        outcome: "Isiphumo",
        expectedCalving: "Ukuzala okulindelekileyo",
        actualCalving: "Ukuzala kwenyani",
        movedBy: "Ishukunyiswe ngu",
        animalOf: "Isilwanyana {{current}} kwezi-{{total}}",
        totalAnimals_one: "Isilwanyana esi-{{count}} kule ngxelo",
        totalAnimals_other: "Izilwanyana ezi-{{count}} kule ngxelo",
        visualTag: "Ithegi ebonakalayo",
        rfidTag: "Ithegi ye-RFID",
        name: "Igama",
        herdTag: "Ithegi yomhlambi/yeqela",
        registrationNumber: "Inombolo yobhaliso",
        species: "Uhlobo lwesilwanyana",
        breed: "Uhlobo",
        sex: "Isini",
        dateOfBirth: "Umhla wokuzalwa",
        status: "Imeko",
        recordCreated: "Irekhodi yenziwe",
        notes: "Amanqaku",
      },
    },
    traceability: {
      ...
      description:
        "Yenza iingxelo ezipheleleyo zokulandelela izilwanyana ngazinye okanye amaqela. Iingxelo ziquka imbali epheleleyo: iirekhodi zempilo, ubunzima, ukuzala, ukushukuma, neefoto.",
  ...
  herdListScreen: {
    ...
    empty: {
      ...
      description:
        "Yongeza isilwanyana sakho sokuqala ukuze uqalise ukulandelela iirekhodi zempilo, ubunzima, ukuzala, nokunye.",
      onboarding: {
        step1: {
  ...
  chuteScreen: {
    ...
    modes: {
      ...
      protocol: {
        title: "Gonya / Nyanga",
        description:
          "Sebenzisa iiprotocol zogonyo okanye unyango ngamayeza abalwe ngokuzenzekelayo",
    ...
    scan: {
      ...
      notFound:
        'Akukho silwanyana sifumanekayo ngethegi "{{tag}}". Yongeza kuqala kwithebhu yoMhlambi.',
      scanning: "Iyaskena...",
  ...
  pasturesScreen: {
    ...
    locked: {
      title: "Ujikelezo lwaMadlelo",
      description:
        "Yenza imephu yamadlelo, wabela imihlambi, kwaye ulandelele iintsuku zokutya ukuze uphucule ingca nempilo yomhlaba.",
      proBadge: "PRO",
    ...
    empty: {
      ...
      description:
        "Sizakukukhokela ekudaleni idlelo lakho lokuqala ngamanyathelo amathathu nje alula",
      button: "Qalisa →",
    },
  },
  animalDetailScreen: {
  ...
  animalFormScreen: {
    ...
    fields: {
      rfidTag: {
        ...
        helpText:
          "Ithegi yombane efakwe kwithegi yendlebe - isicwangciso seCommercial siquka inkxaso yesikena se-RFID",
      ...
      visualTag: {
        ...
        helpText:
          "Sebenzisa iqhosha lesikena sekhamera ukufunda iinombolo zethegi ngokuzenzekelayo kwiifoto",
      },
      name: {
      ...
      vaccinationsUpToDate: {
        ...
        helpOn:
          "Kuza kucwangciswa kuphela ugonyo lwexesha elizayo. Cima ukuba esi silwanyana sisafuna iinaliti zaso zangaphambili.",
        helpOff:
          "Nayiphi na ugonyo esele lulahlekile kwesi silwanyana luya kongezwa njengolugqithisiweyo lixesha.",
      },
      dateOfBirth: {
    ...
    lineage: {
      ...
      dame: {
        ...
        noFemales:
          "Yongeza izilwanyana zabasetyhini kumhlambi wakho kuqala ukuze uzikhethe njengoonina",
      },
    },
    buttons: {
      cancel: "Rhoxisa",
    ...
    alerts: {
      animalLimit: {
        ...
        message:
          "Ufikelele umda wesicwangciso sakho wezilwanyana ezingu-{{limit}}. Phucula ukuze ufumane umda ophezulu — zonke iimpawu sezibandakanyiwe.",
        upgrade: "Phucula",
      },
      validation: {
        duplicateTag: {
          ...
          visualMessage:
            'Itheki ebonakalayo ethi "{{tag}}" sele isetyenziswa ngu-{{name}}. Nceda usebenzise itheki eyahlukileyo.',
          rfidMessage:
            'Itheki ye-RFID ethi "{{tag}}" sele isetyenziswa ngu-{{name}}. Nceda usebenzise itheki eyahlukileyo.',
        },
        tagRequired: {
          title: "Iyafuneka",
          message:
            "Nceda faka mhlawumbi ithegi ye-RFID okanye Ithegi Ebonakalayo (ubuncinane enye iyafuneka)",
        },
        breedRequired: {
          title: "Iyafuneka",
  ...
  bulkAnimalAddScreen: {
    ...
    setup: {
      helpText:
        "Misela amasimi aqhelekileyo kanye, emva koko skena iithegi ngokukhawuleza kwizilwanyana ezininzi ezineempawu ezifanayo.",
  ...
  teamScreen: {
    title: "Iqela",
    noFarm: {
      title: "Akukho fama okwangoku",
      subtitle: "Iqela lakho ngamalungu efama. Yenza ifama ukuze uqale ukwakha iqela lakho, okanye wamkele isimemo ukuze ujoyine elinye.",
      button: "Yenza Ifama",
    },
    loading: "Iyalayisha...",
    inviteButton: "+ Mema",
  ...
  vaccinationScheduleForm: {
    protocolPicker: {
      ...
      emptyHelp:
        "Yongeza isitofu osisebenzisayo — igama lemveliso, umlinganiselo kunye nexesha lokuyeka — uze ukwazi ukusicwangcisa.",
  ...
  vaccinationScheduleScreen: {
    ...
    empty: {
      ...
      noFilter:
        "Yenza amaxesha ukuze izikhumbuzi zogonyo zenziwe ngokuzenzekelayo ngokweminyaka, umhla, okanye iqela.",
    ...
    alerts: {
      ...
      deleteConfirm: {
        title: "Cima iXesha",
        message:
          "Cima ixesha logonyo elithi '{{name}}'? Oku akuyi kuchaphazela iirekhodi zempilo ezikhoyo.",
      },
      deleteError: {
        title: "Impazamo",
