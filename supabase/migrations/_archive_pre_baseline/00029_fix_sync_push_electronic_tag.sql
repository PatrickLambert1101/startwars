-- Fix sync_push function to use rfid_tag instead of electronic_tag
-- This fixes the sync error when creating animals
...
BEGIN
  ...
  -- Process animals - FIXED: Use rfid_tag instead of electronic_tag
