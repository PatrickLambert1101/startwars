-- Add ALL missing columns to sync_push function for animals table
-- Missing: registration_number, photos, herd_tag, tags
...
BEGIN
  ...
  -- Process animals - COMPLETE: All columns now included
