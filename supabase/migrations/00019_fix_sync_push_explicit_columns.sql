-- Replace sync_push with explicit column mapping to fix jsonb_populate_record issues
-- This fixes: "null value in column id of relation memberships violates not-null constraint"
